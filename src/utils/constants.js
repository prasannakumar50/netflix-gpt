...
export const LOGO = "https://assets.nflxext.com/ffe/siteui/vlv3/9f46b569-aff7-4975-9b8e-3212e4637f16/82d5fa1d-52d6-4a74-a58f-38ef1316db1c/PL-en-20240415-popsignuptwoweeks-perspective_alpha_website_large.jpg"
...
export const API_OPTIONS = {
    ...
    headers: {
      ...
      Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI2YzMyZTc0NzA1NGE0MDZmMmU0MTgwMjA3NTdhYzU5MCIsInN1YiI6IjYxNzM5ZmRkMTc2YTk0MDAyM2I0YjhjYyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.v5L9oQpSmRWpPQwsCg4WSreUbALMaLIPfFat1dhlPDA'
    }
  };

  export const IMG_CDN_URL = "https://image.tmdb.org/t/p/w500";

  export const SUPPORTED_LANGUAGES = [{identifier:"en", name:"English"},{identifier:"spanish", name:"Spanish"},{identifier:"turkish", name:"Turkish"},{identifier:"russian", name:"Russian"},{identifier:"hindi", name:"Hindi"}]
