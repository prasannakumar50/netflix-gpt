...
export const API_OPTIONS = {
  ...
  export const SUPPORTED_LANGUAGES = [{identifier:"en", name:"English"},{identifier:"spanish", name:"Spanish"},{identifier:"turkis", name:"Turkish"},{identifier:"russian", name:"Russian"},{identifier:"hindi", name:"Hindi"}]
